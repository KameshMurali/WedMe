...
- Demo: `https://wed.tonewbeginning.com/kammonbeginnings`
- Register: `https://wed.tonewbeginning.com/register`
- Pricing: `https://wed.tonewbeginning.com/pricing`
...
No more juggling 10 WhatsApp groups. 🙏

✨ 5 premium design themes
📋 RSVP tracking across mehendi, sangeet, ceremony & reception
📸 Guest memory uploads after every function
🎨 Publish in minutes, customise everything

Free to start. No card needed.

See a live wedding site → wed.tonewbeginning.com/kammonbeginnings
...
• Guests RSVP for each function separately
• Dress code and venue details for every event
• Everyone's photos collected in one place after
...
Mehendi → Reception, one beautiful site
Per-event RSVPs · dress codes · guest photos
Free to start ↓
```
Link: `wed.tonewbeginning.com/kammonbeginnings` (demo converts better than homepage; switch to a Linktree-style page later if needed.)

### First 9 posts

| # | Format | Hook (first line on screen) | Content |
|---|---|---|---|
| 1 | Reel (screen recording) | "POV: your wedding has 5 events and one website handles all of them" | Scroll through demo site events page, RSVP flow |
| 2 | Carousel | "Your guests have questions. Answer all of them once." | Slides: story / events / dress code / schedule / RSVP / gallery |
...
### Caption formula
Hook line → 2–3 short lines of pain/benefit → CTA ("Demo link in bio") → 8–12 hashtags:
`#indianwedding #desiwedding #sangeet #mehendi #shaadi #weddingwebsite #southasianwedding #nikkah #weddingplanning #desibride #indiangroom #shaadiseason`
...
**Final day:**
> Last call, founding couples. 30% off Forever ends tonight at midnight. 💛

---

## 3. Community Post Templates (Reddit / Facebook)
...
>
> Quick share for anyone planning a multi-event wedding. Our biggest mistake early on was one guest list for everything. What actually works: treat each event as its own guest list (Haldi = family only, Sangeet = everyone, etc.), collect meal prefs + accessibility needs at RSVP time not after, and give guests ONE place to check details so your phone isn't the help desk. Happy to answer questions on how we structured it.
...
## 4. Waitlist "Founding Couple" Welcome Email

**Subject:** You're founding couple #{{number}} 💛
...
>
> Start building → https://wed.tonewbeginning.com/register
> See what's possible → https://wed.tonewbeginning.com/kammonbeginnings
>
> One small ask: if you know another couple getting married, forward them this email. Founding spots are limited to 100.
>
> — Kamesh & the ToNewBeginning team

---

## 5. Price Reference (for all creative)

| Plan | INR | USD | GBP | EUR | AED |
|---|---|---|---|---|---|
| Hello | Free | Free | Free | Free | Free |
| Together (wedding year) | ₹3,499 | $49 | £39 | €45 | AED 179 |
| Forever (lifetime) | ₹7,999 | $99 | £79 | €89 | AED 359 |
